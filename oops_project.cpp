...
{
    t[0].train_no = 1;
    strcpy(t[0].train_name, "Rajya_Rani");
    ...
    t[1].train_no = 2;
    strcpy(t[1].train_name, "Flying_Bullet");
    ...
    t[3].train_no = 4;
    strcpy(t[3].train_name, "Local_City");
    ...
    t[4].train_no = 5;
    strcpy(t[4].train_name, "Duronto_Mail");
    ...
    t[5].train_no = 6;
    strcpy(t[5].train_name, "Shatabdi");
    ...
    t[8].train_no = 9;
    strcpy(t[8].train_name, "Garib_Rath");
    ...
    t[9].train_no = 10;
    strcpy(t[9].train_name, "Humsafar");
    ...
    t[10].train_no = 11;
    strcpy(t[10].train_name, "Deccan_speed");
    ...
    t[11].train_no = 12;
    strcpy(t[11].train_name, "Chennai_Bullet");
    ...
    t[12].train_no = 13;
    strcpy(t[12].train_name, "Shramjeevi");
    ...
    t[13].train_no = 14;
    strcpy(t[13].train_name, "Mail_line");
    strcpy(t[13].start_pl, "PATNA");
    strcpy(t[13].dest_pl, "BHAGALPUR");
    t[13].price = 200;
    t[13].seat = 1500;
    ...
    t[14].train_no = 15;
    strcpy(t[14].train_name, "Weekly_special");
    ...
    t[15].train_no = 16;
    strcpy(t[15].train_name, "Pink_Rail");
    ...
    t[16].train_no = 17;
    strcpy(t[16].train_name, "Rozana_mail");
    strcpy(t[16].start_pl, "GAYA");
    ...
    t[17].train_no = 18;
    strcpy(t[17].train_name, "Sricity_mail");
    strcpy(t[17].start_pl, "PATNA");
    strcpy(t[17].dest_pl, "SRICITY");
    t[17].price = 1200;
    t[17].seat = 2000;
    ...
    t[18].train_no = 19;
    strcpy(t[18].train_name, "Delhi_Tada");
    strcpy(t[18].start_pl, "DELHI");
    strcpy(t[18].dest_pl, "TADA");
    t[18].price = 1110;
    t[18].seat = 1100;
    ...
    t[19].train_no = 20;
    strcpy(t[19].train_name, "Guwahati_Rajdhani");
    strcpy(t[19].start_pl, "CST");
    strcpy(t[19].dest_pl, "GUWAHATI");
    t[19].price = 1200;
    t[19].seat = 2000;
    ...
    t[20].train_no = 21;
    strcpy(t[20].train_name, "Southern_Mail");
    strcpy(t[20].start_pl, "Mumbai");
    strcpy(t[20].dest_pl, "Nagpur");
    t[20].price = 250;
    t[20].seat = 800;
    ...
    t[21].train_no = 22;
    strcpy(t[21].train_name, "Northern_Express");
    strcpy(t[21].start_pl, "PATNA");
    strcpy(t[21].dest_pl, "SIKKIM");
    t[21].price = 1200;
    t[21].seat = 2000;
    ...
    t[22].train_no = 23;
    strcpy(t[22].train_name, "Western_Express");
    strcpy(t[22].start_pl, "GUJARAT");
    strcpy(t[22].dest_pl, "RAJASTHAN");
    t[22].price = 1250;
    t[22].seat = 1800;
    ...
    t[23].train_no = 24;
    strcpy(t[23].train_name, "Bardhman_Express");
    strcpy(t[23].start_pl, "RANCHI");
    strcpy(t[23].dest_pl, "BARDHMAN");
    t[23].price = 200;
    t[23].seat = 1500;
    ...
    t[24].train_no = 25;
    strcpy(t[24].train_name, "Banka_Intercity");
    strcpy(t[24].start_pl, "PATNA");
    strcpy(t[24].dest_pl, "BANKA");
    t[24].price = 1550;
    t[24].seat = 1900;
    ...
    t[25].train_no = 26;
    strcpy(t[25].train_name, "Central_Express");
    strcpy(t[25].start_pl, "JAIPUR");
    strcpy(t[25].dest_pl, "JABALPUR");
    t[25].price = 1800;
    t[25].seat = 2000;
    ...
    t[26].train_no = 27;
    strcpy(t[26].train_name, "Lokmanya_tilak");
    strcpy(t[26].start_pl, "MUMBAI");
    strcpy(t[26].dest_pl, "BHAGALPUR");
    t[26].price = 1900;
    t[26].seat = 2200;
    ...
    t[27].train_no = 28;
    strcpy(t[27].train_name, "Dibrugarh-Rajdhani");
    strcpy(t[27].start_pl, "PATNA");
    strcpy(t[27].dest_pl, "DIBRUGARH");
    t[27].price = 1200;
    t[27].seat = 2000;
    ...
    t[28].train_no = 29;
    strcpy(t[28].train_name, "Magadh_Express");
    strcpy(t[28].start_pl, "DELHI");
    strcpy(t[28].dest_pl, "RAJGIR");
    t[28].price = 1110;
    t[28].seat = 1100;
    ...
    t[29].train_no = 30;
    strcpy(t[29].train_name, "Zonal_Express");
    strcpy(t[29].start_pl, "HYDERABAD");
    ...
    t[30].train_no = 31;
    strcpy(t[30].train_name, "Pune_Mail");
    strcpy(t[30].start_pl, "PATNA");
    ...
    t[31].train_no = 32;
    strcpy(t[31].train_name, "Gujarat_Mail");
    strcpy(t[31].start_pl, "Gandhinagar");
    ...
    t[32].train_no = 33;
    strcpy(t[32].train_name, "Punjab_Mail");
    strcpy(t[32].start_pl, "BHOPAL");
    strcpy(t[32].dest_pl, "CHANDIGARH");
    t[32].price = 1250;
    t[32].seat = 1800;
    ...
    t[33].train_no = 34;
    strcpy(t[33].train_name, "Doon_Express");
    strcpy(t[33].start_pl, "PATNA");
    strcpy(t[33].dest_pl, "DEHRADUN");
    t[33].price = 200;
    t[33].seat = 1500;
    ...
    t[34].train_no = 35;
    strcpy(t[34].train_name, "Vananchal_Express");
    strcpy(t[34].start_pl, "KOLKATA");
    strcpy(t[34].dest_pl, "JAMSHEDPUR");
    t[34].price = 1550;
    t[34].seat = 1900;
    ...
    t[35].train_no = 36;
    strcpy(t[35].train_name, "Bhoapal_Express");
    strcpy(t[35].start_pl, "GUWAHATI");
    ...
    t[36].train_no = 37;
    strcpy(t[36].train_name, "Bihar_Mail");
    strcpy(t[36].start_pl, "BHAGALPUR");
    strcpy(t[36].dest_pl, "PUNJAB");
    t[36].price = 1900;
    t[36].seat = 2200;
    ...
    t[37].train_no = 38;
    strcpy(t[37].train_name, "Chandigarh_intercity");
    strcpy(t[37].start_pl, "PATNA");
    strcpy(t[37].dest_pl, "CHANDIGARH");
    t[37].price = 1200;
    t[37].seat = 2000;
    ...
    t[38].train_no = 39;
    strcpy(t[38].train_name, "Azam_express");
    strcpy(t[38].start_pl, "DELHI");
    strcpy(t[38].dest_pl, "LUCKNOW");
    t[38].price = 1110;
    t[38].seat = 1100;
    ...
    t[39].train_no = 40;
    strcpy(t[39].train_name, "Bengaluru_Express");
    strcpy(t[39].start_pl, "TIRUPATI");
